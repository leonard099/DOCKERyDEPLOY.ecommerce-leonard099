...
import { IsEmail, IsNumber, IsString, Length, IsNotEmpty, IsInt, Min, Max, Matches, IsOptional} from "class-validator"
...
export class UsersDTOPost {
    ...
    @ApiProperty({
        description:'La contraseña del usuario debe tener al menos: una mayuscula,una minuscula, un numero, un carcater especial. Y debe tener de 8 a 15 digitos',
         example:'12345678aA!',
    })
    password:string
...
export class UsersDTOPut {
    ...
    @Max(9999999999)
    @ApiPropertyOptional({
        description:'Numero de telefono celular del usuario, con 10 cifras // Puede ser pasado o no',
        example: 2664404040
    })
    phone?:number
